package com.example.android.lda.adapter
...
import com.example.android.lda.Activity.DescriptionActivity
import com.example.android.lda.Activity.ProductActivity
...
class ProductAdapter (
    ...
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        holder.apply {
            ...
            price.text =
                (Math.round(product.price * (100 - product.discountPercentage)) / 100.0).toString()
...
//
            cardView.setOnClickListener {
                val intent: Intent = Intent(context, DescriptionActivity::class.java)
